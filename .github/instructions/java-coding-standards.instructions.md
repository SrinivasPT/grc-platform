...
description: 'Java coding standards and idioms for GRC platform. Use when writing or reviewing any Java source file.'
---
...
### Iterable → Stream via StreamSupport — no manual iterator loops
