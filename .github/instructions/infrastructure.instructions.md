...
description: 'Infrastructure rules for GRC platform: Docker Compose, Tekton pipelines, Keycloak configuration, bash scripts. Use when writing or reviewing infrastructure files.'
---

# Infrastructure — Docker / Tekton / Keycloak Rules
