---
applyTo: 'backend/platform-workflow/**'
description: 'platform-workflow module rules: workflow state machine, transitions, escalation, outbox pattern. Use when writing or reviewing platform-workflow code.'
---

# platform-workflow — Module Rules
