...
class GraphProjectionWorkerTest {
    ...
    @Mock ChangeTrackingRepository changeTrackingRepo;
    @Mock GraphSyncStateRepository syncStateRepo;
    @Mock Driver neo4jDriver;
    @Mock Session neo4jSession;
    ...
    void worker_syncsNewRelation_toNeo4j() {
        ...
        TrackedChange change = new TrackedChange("records", "INSERT",
    ...
    void worker_isIdempotent_onReplay() {
        ...
        TrackedChange change = new TrackedChange("records", "UPDATE",
                UUID.randomUUID().toString(), "{}");
    ...
    void worker_resumesFromLastVersion_onRestart() {
        ...
        when(changeTrackingRepo.getChangesSince(7L)).thenReturn(List.of(
    ...
    void worker_marksRelationInactive_onSoftDelete() {
        ...
        TrackedChange change = new TrackedChange("records", "DELETE",
                UUID.randomUUID().toString(), "{}");
