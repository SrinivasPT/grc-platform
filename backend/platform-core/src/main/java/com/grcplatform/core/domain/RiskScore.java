...
public class RiskScore {
    ...
    public BigDecimal getLikelihoodScore() {
    ...
    public BigDecimal getInherentScore() {
    ...
    public BigDecimal getResidualLikelihood() {
        return residualLikelihood;
    }

    public BigDecimal getResidualImpact() {
        return residualImpact;
    }

    public BigDecimal getResidualScore() {
    ...
    public String getAppetiteAlignment() {
        return appetiteAlignment;
    }
