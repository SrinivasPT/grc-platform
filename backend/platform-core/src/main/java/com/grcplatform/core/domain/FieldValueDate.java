...
@Entity
@Table(name = "field_values_date")
public class FieldValueDate {
    ...
    public static FieldValueDate of(UUID orgId, UUID recordId, UUID fieldDefId, Instant value) {
        FieldValueDate fv = new FieldValueDate();
        fv.orgId = orgId;
